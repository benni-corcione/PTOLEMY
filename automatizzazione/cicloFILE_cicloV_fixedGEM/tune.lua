...
function segment.flym()
  ...
  for k=1,N_files do
    ...
    for i=1,V1_count do
      ...
      local fname = string.format("output/simulazione_file_%d_V1_%d_V2_%d.txt",k,V1_voltage,V2_voltage)
      ...
      simion.printer.filename = string.format("output/results_file_%d_V1_%d_V2_%d.png",k,V1_voltage,V2_voltage)
      simion.printer.scale = 1
      simion.print_screen()

      results_file:write("FILE="..k.."  V1="..V1_voltage.."  V2="..V2_voltage.."\n")
    end
  end
