...
adjustable V1_begin = -5000 -- Source
adjustable V2_begin = -5000   -- elettrodo
adjustable V1_step = 50   -- V1 voltage step size
adjustable V2_step = 50   -- V2 voltage step size
adjustable V1_count = 40  -- V1 voltage number of steps
adjustable V2_count = 40  -- V2 voltage number of steps
adjustable excel_enable = 1  -- Use Excel? (1=yes, 0=no)

adjustable energia_begin =1 -- Source
adjustable energia_step = 1
adjustable energia_count = 1
...
function segment.flym()
  ...
  for V2_pos = 1,V2_count do
    ...
    for energia_pos = 1,energia_count do
  ...
  for V1_pos = 1,V1_count do
      ...
      ENER = energia_begin + (energia_pos - 1) * energia_step
...
--      print('result: V1='..V1_voltage..',V2='..V2_voltage..',nhits='..nhits..',AngoloI='..angoloInternoMax..'°,esterni='..esterni..',AngoloE='..angoloEsternoMax..'°')
      if excel_enable ~= 0 then
        ...
        excel_ws.Cells(2, V1_count+1+V1_pos+1).Value2 = V1_voltage
        excel_ws.Cells(energia_pos+2, V1_count+1+1).Value2 = ENER
        excel_ws.Cells(energia_pos+2, V1_count+1+V1_pos+1).Value2 = nhits
