...
int main(int argc, char* argv[]){
  ...
  for(int i=0; i<filenames.size(); i++){  
    ...
    //nome tipico name_d600um_cnt15um_sub5000um_V100_dist100um
    std::string   d_str = AndCommon::splitString(filenames[i],"_d"   )[1].c_str(); //600um_cnt15um_sub5000um_V100_dist100um
    std::string cnt_str = AndCommon::splitString(filenames[i],"_cnt" )[1].c_str(); //15um_sub5000um_V100_dist100um
    std::string sub_str = AndCommon::splitString(filenames[i],"_sub" )[1].c_str(); //5000um_V100_dist100um
    std::string   V_str = AndCommon::splitString(filenames[i],"_V"   )[1].c_str(); //100_dist100um
